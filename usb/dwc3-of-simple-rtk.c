...
static const struct dev_pm_ops dwc3_of_simple_rtk_dev_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(dwc3_of_simple_suspend, dwc3_of_simple_resume)
	SET_RUNTIME_PM_OPS(dwc3_of_simple_runtime_suspend,
			dwc3_of_simple_runtime_resume, NULL)
};

static const struct of_device_id of_dwc3_simple_rtk_match[] = {
...
MODULE_DEVICE_TABLE(of, of_dwc3_simple_rtk_match);

static struct platform_driver dwc3_of_simple_rtk_driver = {
	.probe		= dwc3_of_simple_probe,
	.remove_new	= dwc3_of_simple_remove,
	.shutdown	= dwc3_of_simple_shutdown,
	.driver		= {
		.name	= "dwc3-of-simple-rtk",
		.of_match_table = of_dwc3_simple_rtk_match,
		.pm	= &dwc3_of_simple_rtk_dev_pm_ops,
	},
};

module_platform_driver(dwc3_of_simple_rtk_driver);
MODULE_LICENSE("GPL v2");
MODULE_DESCRIPTION("DesignWare USB3 OF Simple RTK Glue Layer");
